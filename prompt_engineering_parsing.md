...
Strictly output only the JSON object as shown above, filled with the extracted data. Do not include any commentary, explanation, or formatting outside the JSON.
```
